...
const CompactPlayer: FC<{ url: string; }> = ({ url}) => {
...
const WaveBottomExtend4: FC<Props> = ({ file, activeSegmentProp, url, keywords, channelCount }) => {
...
export default WaveBottomExtend4;